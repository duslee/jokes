...
import com.common.as.image.ImageDecorator;
...
public class AsyncImageView extends ImageView implements ImageRequestCallback {
    ...
    private ImageDecorator mImageProcessor;
...
//    }
    ...
    public void reloadOnlyMemory(){
    	reload(false, false);
    }
    
    public void reloadOnlyMemory(boolean force){
    	reload(force, false);
    }
     ...
     */
    public void reload(boolean force, boolean bCheckFromFile) {
        if (mRequest == null && mUrl != null) {
            ...
            setDefaultImage();
            mRequest = new ImageRequest(getContext(),mUrl, this, mImageProcessor, mOptions);
            mRequest.load(getContext(), bCheckFromFile);
        }
    }
    ...
    public void setAsyncImage(String url, ImageDecorator decorator){
    	setImageProcessor(decorator);
    	setUrl(url);
    }

    public void setAsyncImage(String url, ImageDecorator decorator, boolean bCheckFromFile){
    	setImageProcessor(decorator);
    	setUrl(url, bCheckFromFile);
    }
    ...
    private void setUrl(String url, boolean bCheckFromFile) {
     ...
     * @see ImageProcessor
     */
    public void setImageProcessor(ImageDecorator imageProcessor) {
