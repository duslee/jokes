...
public class RealSystemFacade implements SystemFacade {
    ...
    // 2 GB
    private static final int DOWNLOAD_MAX_BYTES_OVER_MOBILE = 500 * 1024 * 1024;
    // 1 GB
    private static final int DOWNLOAD_RECOMMENDED_MAX_BYTES_OVER_MOBILE = 200 * 1024 * 1024;
    ...
    public int getMaxBytesOverMobile() {
	return DOWNLOAD_MAX_BYTES_OVER_MOBILE;
    }

    @Override
    public int getRecommendedMaxBytesOverMobile() {
