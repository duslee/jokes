...
public final class Downloads implements BaseColumns {
     ...
     */
    public static String AUTHORITY = "com.mozillaonline.downloads";

    
    public static void setAuthority(Context ctx){
    	AUTHORITY = ctx.getPackageName()+".downloads";
    	CONTENT_URI = Uri.parse("content://" + AUTHORITY
    		    + "/my_downloads");
    	ALL_DOWNLOADS_CONTENT_URI = Uri.parse("content://"
    ...
    public static final String COLUMN_APP_PACKAGENAME = "app_package_name";
