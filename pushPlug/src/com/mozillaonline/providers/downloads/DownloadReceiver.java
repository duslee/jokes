...
public class DownloadReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
    	BaseLog.i("main2", "DownloadReceiver.onReceive");
        if (mSystemFacade == null) {
            mSystemFacade = new RealSystemFacade(context);
        }

        String action = intent.getAction();
        BaseLog.i("main2", "DownloadReceiver.action="+intent.getAction());
    ...
    private void handleNotificationBroadcast(Context context, Intent intent) {
    	BaseLog.i("main2", "DownloadReceiver.handleNotificationBroadcast");
    ...
    private void hideNotification(Context context, Uri uri, Cursor cursor) {
    	BaseLog.d("main3", "DownloadReceiver.hideNotification");
    ...
    private void openDownload(Context context, Cursor cursor) {
    	BaseLog.i("main2", "DownloadReceiver.openDownload");
    ...
    private void startService(Context context) {
    	BaseLog.d("main2", "DownloadReceiver.startService");
