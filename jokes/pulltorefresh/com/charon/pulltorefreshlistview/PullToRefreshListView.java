...
public class PullToRefreshListView extends ListView {
    ...
    private void initView(Context context) {
        ...
        Log.e("bmp test", "mHeaderHeight:"+mHeaderHeight);
...
//            	Log.e("bmp test", "onTouchEvent ACTION_MOVE 3");
...
//                	Log.e("bmp test", "onTouchEvent ACTION_MOVE 32");
                    ...
                    if (pullDistance < 0) {
                        ...
                        mState = State.ORIGNAL;
                        changeState();
//                        Log.e("bmp test", "onTouchEvent ACTION_MOVE 33");
                    } else if (pullDistance < mHeaderHeight) {
//                    	Log.e("bmp test", "onTouchEvent ACTION_MOVE 34");
                        mState = State.PULL_TO_REFRESH;
                        isBack = true;
                        changeState();
                    }
...
//                	Log.e("bmp test", "header padding:"+(int) (pullDistance - mHeaderHeight));
...
//            Log.e("bmp test", "changeState ORIGNAL");
        } else if (mState == State.PULL_TO_REFRESH) {
            iv_arrow.setVisibility(View.VISIBLE);
            pb_refresh.setVisibility(View.GONE);
            tv_title.setVisibility(View.VISIBLE);
...
//            Log.e("bmp test", "changeState REFRESHING");
