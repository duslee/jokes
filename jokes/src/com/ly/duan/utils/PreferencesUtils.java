...
public class PreferencesUtils {
	...
	/** 应用版本号信息存储位置 */
	public static final String SHARED_VERCODE_NAME = "shared_vercode";
	...
	public static boolean putString(Context context, String preferenceName,
	...
	public static boolean putInt(Context context, String preferenceName,
	...
	public static boolean putLong(Context context, String preferenceName,
	...
	public static boolean putFloat(Context context, String preferenceName,
	...
	public static boolean putBoolean(Context context, String preferenceName,
	...
	public static SharedPreferences getVerCodePreferences(Context context){
		return context.getSharedPreferences(SHARED_VERCODE_NAME, Context.MODE_PRIVATE);
	}
