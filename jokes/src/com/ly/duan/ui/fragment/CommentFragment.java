...
//				BasicUiUtils.setLVHeight(listView);
	...
	public static CommentFragment newInstance(int contentType, ArticleBean articleBean) {
	...
	public static CommentFragment newInstance(int contentType, DuanBean duanBean, boolean insertAds) {
		LogUtils.d("newInstance 11111");
		return newInstance(contentType, duanBean, insertAds, false);
	}

	public static CommentFragment newInstance(int contentType, DuanBean duanBean, boolean insertAds, boolean isAds) {
		LogUtils.d("newInstance 11111");
		CommentFragment fragment = new CommentFragment();
		Bundle args = new Bundle();
		args.putInt("contentType", contentType);
	...
	public static CommentFragment newInstance(int contentType,
