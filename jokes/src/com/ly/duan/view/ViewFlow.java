...
//				sendMessageDelayed(message, timeSpan);
				sendEmptyMessageDelayed(0, timeSpan);
			}
		};
	}
...
//					"ViewFlow can only be used in EXACTLY mode.");
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			// Logs.e("main", "xDiff= " + xDiff + ", mTouchSlop= " + mTouchSlop
			// + ", mCurrentAdapterIndex=" + mCurrentAdapterIndex
			// + ", mSideBuffer=" + mSideBuffer);
			...
			if (isOnClick) {
				getOnItemClickListener()
						.onItemClick(
								...
								getItemIdAtPosition(mCurrentAdapterIndex
										% mSideBuffer));
			}
