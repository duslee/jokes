...
public class BitmapUtils implements TaskHandler {
	...
	public <T extends View> void display(T container, String uri,
		...
		// LogUtils.e("BitmapSize.width=" + size.getWidth() +
		// ", BitmapSize.height=" + size.getHeight());
...
//			callBack.setDrawable(container, new AsyncDrawable<T>(loadingDrawable, loadTask));
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			switch (msg.what) {
			case 0:
				// TODO: when there's no image in cache iv display null
...
//			LogUtils.e("(bitmap != null)=" + (bitmap != null));
		...
		protected void onPostExecute(Bitmap bitmap) {
			final T container = this.getTargetContainer();
//			LogUtils.e("(container != null)=" + (container != null));
			if (container != null) {
				if (bitmap != null) {
